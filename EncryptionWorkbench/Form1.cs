...
namespace EncryptionWorkbench
{
    public partial class Form1 : Form
    {
        ...
        {
            //This ensures there is an imput or it will throw an error
        ...
        private void substitution (bool encrypt)
        {
             ...
             *      Add elements to the dictionary using the original alphabet and the shifted alphabet as keys and pairs (order varies depending on encryption or decryption)
